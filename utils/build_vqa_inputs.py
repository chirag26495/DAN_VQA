...
def main(args):
    ...
    np.save(args.output_dir+'/train.npy', np.array(train), allow_pickle=True)
    np.save(args.output_dir+'/valid.npy', np.array(valid), allow_pickle=True)
    np.save(args.output_dir+'/train_valid.npy', np.array(train+valid), allow_pickle=True)
    np.save(args.output_dir+'/test.npy', np.array(test), allow_pickle=True)
    np.save(args.output_dir+'/test-dev.npy', np.array(test_dev), allow_pickle=True)
